...
“/create-workout-simple”: “GET - Create workout (iOS Shortcuts friendly)”,
...
“””
Create a Garmin workout using GET request (easier for iOS Shortcuts)

```
Usage:
/create-workout-simple?workout=5 min easy&email=you@example.com&password=yourpass

Example workouts:
- "10 min warmup, 5x(800m, 400m easy), 10 min cooldown"
...
try:
    ...
    workout_json = parser.parse(workout)
    
    # Override name if provided
    if name:
        workout_json["workoutName"] = name
